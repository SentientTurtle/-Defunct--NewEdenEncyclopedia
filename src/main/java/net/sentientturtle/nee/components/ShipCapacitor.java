...
public class ShipCapacitor extends Component {
    ...
    public ShipCapacitor(Type type, DataSupplier dataSupplier, Page page) {
    ...
    public String buildHTML() {
        ...
        return "<div class='component ship_capacitor text_font'>\n" +
                ...
                "        <tr>\n" +
                "            <td><span class='capacitor_span' title='Capacitor Capacity'><img src='" + ResourceLocation.iconOfIconID(attributeMap.get(482).iconID, dataSupplier, page) + "' height='32px' width='32px'>Capacitor Capacity: " + dataSupplier.unitify(attributeValueMap.get(new Tuple2<>(type.typeID, 482)), attributeMap.get(482).unitID, page) + "</span>\n" +
                "            </td>\n" +
                "            <td class='cap_recharge_time'><span class='capacitor_span' title='Capacitor Recharge Time'><img src='" + ResourceLocation.iconOfIconID(attributeMap.get(55).iconID, dataSupplier, page) + "' height='32px' width='32px'>Recharge Time: " + dataSupplier.unitify(attributeValueMap.getOrDefault(new Tuple2<>(type.typeID, 55), 0.0), attributeMap.get(55).unitID, page) + "</span>\n" +
                "            </td>\n" +
                "        </tr>\n" +
                "    </table>\n" +
                "</div>";
